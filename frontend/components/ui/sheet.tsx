  ...
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        side === "right"
          ? "inset-y-0 right-0 h-full w-full sm:max-w-sm data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right"
...
const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn("flex flex-col gap-2 px-6 py-4 border-t mt-auto", className)}
    {...props}
  />
);
